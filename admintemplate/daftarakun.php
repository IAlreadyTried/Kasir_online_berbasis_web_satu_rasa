                            ...
                            <div class="col-12">
                                <div class="card" style="width: 137%;">
                                    <div class="card-header card-header-tabel">
                                        <h4>Pesanan Masuk <?php var_dump($jumlahData); ?><?php var_dump($jumlahHalaman); ?><?php var_dump($halamanAktif); ?></h4>
                                    </div>
                                    ...
                                    <div class="card-body kartu-tabel">
                                        <table width="100%" cellspacing="0" cellpadding="5" class="tabelku">
                                            ...
                                            <tr class="tr">
                                                ...
                                                <td class="td">
                                                    <?php 
                                                        if(($satuan_online['status'] == 'online')||($satuan_online['status'] == 'bayar')) {
