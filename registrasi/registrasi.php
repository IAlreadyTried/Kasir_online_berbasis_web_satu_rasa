...
<body>
    <div class="untuk-laptop container-fluid row">
        <div class="col-6 left">
            ...
            <h1 style="margin-top:-20px;" class="satu">RASA.</h1>
            <h2 style="font-weight: bold;color: #000000;margin-top:-17px;" class="sedap">Sedap Dipandang Lezat Dimakan</h2>
        </div>
        <div class="col-6 right d-flex justify-content-center align-items-center">
            ...
            <form action="" method="post">
                ...
                <input required type="text" placeholder="Nama Anda" name="nama">
                </div>
                <div class="input-field">
                    <i class="bi bi-person"></i>
                ...
                <input required type="text" placeholder="Nomor Telepon" name="telepon">
                </div>
                <div class="input-field">
                ...
                <input required type="password" placeholder="Password" name="password" id="passnya">
                <input style="float:right;margin-top: 10px;margin-right: 5px;" type="checkbox" onclick="showpass()">
                </div>
    ...
    <div class="untuk-hape container-untuk-hape container-fluid d-flex justify-content-center align-items-center">
        <div class="container-dalam-hape"><div class="d-flex justify-content-center align-items-center">
            <form action="" method="post">
                ...
                <input type="submit" class="tombol" value="DAFTAR" name="submit"> required
                <h4 class="buat buat-akun">Sudah memiliki akun? <a href="../login/login.php" style="font-family: 'Suez One', serif; text-decoration: none; color: black;">LOGIN</a></h4>
            </form>
        </div></div>
    </div>
