...
$nampak = "none";
$result = mysqli_query($conn, "SELECT status FROM user WHERE username = '$username'");
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <div style="position: relative;" class="col-lg-6 col-md-6 col-sm-6 d-flex align-items-center justify-content-center" >
            ...
            <a style="position: fixed;bottom:20px;right:170px;z-index:100;display:<?php echo $nampak; ?>;" type="button" class="nav-link" onclick="return confirm('Anda yakin ingin keluar?')" href="../logout.php">LOG OUT</a>
        </div>
    </div>
