<?php 
    ...
    if(isset($_POST['tambah'])) {
        if(!isset($_SESSION['login'])) {
            echo "<script>
                   let pindah = confirm('Silahkan login untuk memesan');
                    if(pindah) {
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" onclick="return confirm('Anda yakin ingin keluar?')" href="../logout.php">LOG OUT</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container-fluid d-flex align-items-center justify-content-center">
        ...
        <div id="menunya" class="background-menu row ">
            <?php foreach($menus as $menu) : ?>
                <?php $hilanggak = "inline-block"; $nggakhilang = "none";$maks = $menu['stok'];?>
                <?php if($menu['stok'] <= 0) {
                    $hilanggak = "none";
            ...
            <button style="position: fixed;bottom:20px;left:20px;z-index:100;width:170px;display:<?php echo $sembunyi; ?>;" type="button" class="btn btn-primary tombol_komen" data-toggle="modal" data-target="#exampleModal">
    Berikan Komentar
</button>
        </div>
        <br>
